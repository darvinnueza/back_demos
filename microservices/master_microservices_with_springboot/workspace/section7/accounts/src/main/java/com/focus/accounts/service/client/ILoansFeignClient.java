...
import com.focus.accounts.service.client.impl.LoansFallback;
 ...
 */
@FeignClient(name = "loans", fallback = LoansFallback.class) // Define el cliente Feign para el servicio "loans", y define un fallback en caso de fallos.
